...
namespace Gcd.Version._3
{
    ...
    public static class GcdAlgorithms
    {
        ...
        private static int Gcd(IAlgorithm algorithm, params int[] numbers) => AlgorithmMultipleLogic.Calculate(algorithm, numbers);

        private static int Gcd(IAlgorithm algorithm, out long milliseconds, params int[] numbers) => AlgorithmMultipleLogic.Calculate(algorithm, out milliseconds, numbers);
        ...
        private static void ThrowExceptionWhenMinValueOrAllZeros(params int[] numbers)
        {
            ...
            {
                throw new ArgumentException("All the arguments are zeros.");
            }
        }
    }
}
